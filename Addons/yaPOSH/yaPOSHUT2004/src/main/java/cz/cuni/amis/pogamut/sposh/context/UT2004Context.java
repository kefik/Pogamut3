 ...
 * @author Honza
 */
public class UT2004Context<BOT extends UT2004Bot> extends UT2004ContextBase<BOT> implements IUT2004Context<BOT> {
		 ...
		 * <p><p>
		 * Can be used only iff {@link NavMeshModule#isInitialized()}.
		 * <p><p>
		 * May be used since {@link IUT2004BotController#botInitialized(cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages.GameInfo, ConfigChange, InitedMessage)} 
	     * is called.
	     * <p><p>
		...
		/**
		 * Team-comm client, if {@link UT2004TCServer} is up, provides way for the quick communication between Java bots.
		 */
