...
public class TCRequestJoinChannel extends TCRequestData {
	...
	public static final IToken MESSAGE_TYPE = Tokens.get("TCRequestJoinChannel");
	
	private int channelId;

	public TCRequestJoinChannel(long simTime) {
	...
	public String toString() {
		return "TCRequestJoinChannel[channelId=" + channelId + "]";
	}
