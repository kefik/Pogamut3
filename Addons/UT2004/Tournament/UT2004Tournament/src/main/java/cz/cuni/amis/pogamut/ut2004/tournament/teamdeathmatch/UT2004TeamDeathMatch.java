...
public class UT2004TeamDeathMatch extends UT2004Match<UT2004TeamDeathMatchConfig, UT2004TeamDeathMatchResult> {
	...
	protected void outputResults(UCCWrapper ucc, UT2004Server server, UT2004Analyzer analyzer, Bots bots, UT2004MatchResult result,	File outputDirectory) {
		if (!(result instanceof UT2004TeamDeathMatchResult)) {
			throw new PogamutException("Can't out results! Expected results of class UT2004TeamDeathMatchResult and got " + result.getClass().getSimpleName() + "!", log, this);
		}
		outputResults_step1((UT2004TeamDeathMatchResult) result, outputDirectory);
		outputResults_step2((UT2004TeamDeathMatchResult) result, outputDirectory);
	}
