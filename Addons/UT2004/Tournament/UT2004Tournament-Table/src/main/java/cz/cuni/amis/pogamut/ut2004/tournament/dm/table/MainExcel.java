...
import cz.cuni.amis.pogamut.ut2004.tournament.dm.table.report.DMExcelReport;
...
public class MainExcel {
	...
	private static void fail(String errorMessage, Throwable e) {
        ...
        System.out.println("Usage: java -jar ut2004-tournament-dm-excel-onejar.jar ");
	...
	private static void generate() {
		DMExcelReport report = new DMExcelReport(resultDirFile, outputFile);
		report.generate();
	}
...
//      FOR TESTING
		if (args == null || args.length == 0) {
			args = new String[] {
				"-r",
				"d:\\MFF\\NAIL068-UmeleBytosti\\Lectures\\AB2022-Labs\\Lab05-SpatialAwareness\\Students\\_Results\\",
				"-o",
				"d:\\MFF\\NAIL068-UmeleBytosti\\Lectures\\AB2022-Labs\\Lab05-SpatialAwareness\\Students\\_Results\\",
			};
		}
