...
{
	private String doNotUnpackIfMarkerExists;
	...
	public String getDoNotUnpackIfMarkerExists() {
		return doNotUnpackIfMarkerExists;
	}

	public void setDoNotUnpackIfMarkerExists(String doNotUnpackIfMarkerExists) {
		this.doNotUnpackIfMarkerExists = doNotUnpackIfMarkerExists;
	}
