...
public class PogamutJMXException extends PogamutException {
	 ...
	 * @param origin which object does produced the exception
	 */
	public PogamutJMXException(String message, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public PogamutJMXException(String message, Throwable cause, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public PogamutJMXException(String message, Logger log, Object origin){
	 ...
	 * @param origin which object does produced the exception
	 */
	public PogamutJMXException(String message, Throwable cause, Logger log, Object origin) {
