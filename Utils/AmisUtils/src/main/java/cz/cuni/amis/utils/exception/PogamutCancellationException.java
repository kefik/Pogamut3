...
public class PogamutCancellationException extends PogamutException {
	 ...
	 */
	public PogamutCancellationException(String message, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public PogamutCancellationException(String message, Throwable cause, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public PogamutCancellationException(String message, Logger log, Object origin){
	 ...
	 * @param origin which object does produced the exception
	 */
	public PogamutCancellationException(String message, Throwable cause, Logger log, Object origin) {
