package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
 	...
 	public class FallEdge 
		 ...
		 * 
		 *   
		 *     @param Location Current location of the bot.
		 *   
		 * 
		 */
		public FallEdge(
			boolean Fell,  Location Location
		) {
		 ...
		 * @param original
		 */
		public FallEdge(FallEdge original) {		
			
					this.Fell = original.isFell()
 	;
        ...
        public  Location getLocation()
 	 {
 		...
 		public String toHtmlString() {
 			return super.toString() + "[<br/>" +
		              			...
		              			"<b>Fell</b> = " + String.valueOf(isFell()
 	) + " <br/> " + 
