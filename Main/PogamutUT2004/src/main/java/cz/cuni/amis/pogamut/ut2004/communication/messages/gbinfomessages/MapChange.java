package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
         ...
         *  
		Asynchronous message. Sent when the map is changed (we will
		loose connection to the server for some time).
 	...
 	public class MapChange 
		 ...
		 * @param original
		 */
		public MapChange(MapChange original) {		
        ...
        public  String getMapName()
 	 {
 	    ...
 	    public String toString() {
            return
            	super.toString() + "[" +
		              			...
		              			"MapName = " + String.valueOf(getMapName()
 	) + " | " + 
 		...
 		public String toHtmlString() {
 			return super.toString() + "[<br/>" +
		              			...
		              			"<b>MapName</b> = " + String.valueOf(getMapName()
 	) + " <br/> " + 
