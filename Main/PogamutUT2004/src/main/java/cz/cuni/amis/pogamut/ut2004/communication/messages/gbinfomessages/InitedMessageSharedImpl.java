package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
         ...
         */
 	public class InitedMessageSharedImpl 
  						extends
  						InitedMessageShared
	    {
		...
		public InitedMessageSharedImpl(WorldObjectId objectId, Collection<ISharedProperty> properties) {
			...
			if (properties.size() != 0) {
				throw new PogamutException("Not enough properties passed to the constructor.", InitedMessageSharedImpl.class);
			}
			...
			for ( ISharedProperty property : properties ) {
				...
				if ( !objectId.equals( property.getObjectId() )) {
					...
					throw new PogamutException("Trying to create a InitedMessageSharedImpl with different WorldObjectId properties : " + 
											    this.Id.getStringId() + " / " + property.getObjectId().getStringId() , this);
				}
				if (!InitedMessageShared.SharedPropertyTokens.contains(pId.getPropertyToken())) {
				// property that does not belong here
				throw new PogamutException("Trying to create a InitedMessageSharedImpl with invalid property (invalid property token): " + 
				...
				propertyMap.put(property.getPropertyId(), property);
						...
						private UnrealId Id = cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages.InitedMessage.InitedMessageId;
   				...
   				public void setSimTime(long SimTime) {
					super.setSimTime(SimTime);
	    				...
	    				@Override
	    				public 
	    				InitedMessageSharedImpl clone() {
	    					return new 
	    					InitedMessageSharedImpl(this);
	    				}
    	...
    	public static class InitedMessageSharedUpdate
     implements ISharedWorldObjectUpdatedEvent
		{
	
			private InitedMessageShared object;
			private long time;
			private ITeamId teamId;
			
			public InitedMessageSharedUpdate
