 	...
 	;
		...
		public IStaticWorldObject getStatic() {
			...
			public static class ObjectDisappeared implements ILocalWorldObjectUpdatedEvent
			{
				...
				public ObjectDisappeared(NavPointLocal obj, long time) {
					this.obj = obj;
					this.time = time;
				}
				
				private NavPointLocal obj;
				private long time;
				...
				public IWorldObjectUpdateResult<ILocalWorldObject> update(ILocalWorldObject obj) 
				{
					...
					if (!(obj instanceof NavPointLocalImpl)) {
						throw new PogamutException("Can't update different class than NavPointLocalImpl, got class " + obj.getClass().getSimpleName() + "!", this);
					}
					NavPointLocalImpl toUpdate = (NavPointLocalImpl)obj;
					if (toUpdate.Visible) {
