package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
         ...
         */
 	public abstract class BombInfoLocal 
  						extends InfoMessage
 	...
 	;
		...
		public IStaticWorldObject getStatic() {
			...
			public static class ObjectDisappeared implements ILocalWorldObjectUpdatedEvent
			{
				...
				public ObjectDisappeared(BombInfoLocal obj, long time) {
					this.obj = obj;
					this.time = time;
				}
				
				private BombInfoLocal obj;
				private long time;
				...
				public IWorldObjectUpdateResult<ILocalWorldObject> update(ILocalWorldObject obj) 
				{
					...
					if (!(obj instanceof BombInfoLocalImpl)) {
						throw new PogamutException("Can't update different class than BombInfoLocalImpl, got class " + obj.getClass().getSimpleName() + "!", this);
					}
					BombInfoLocalImpl toUpdate = (BombInfoLocalImpl)obj;
					if (toUpdate.Visible) {
