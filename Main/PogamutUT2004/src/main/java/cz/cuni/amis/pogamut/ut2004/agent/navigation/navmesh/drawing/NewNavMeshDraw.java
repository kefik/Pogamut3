...
public class NewNavMeshDraw extends UT2004Draw implements INavMeshDraw {

    private NavMesh navMesh;
    
    private final static int zOffset = 30;
    
    public NewNavMeshDraw(NavMesh navMesh, Logger log, IUT2004ServerProvider serverProvider) {
