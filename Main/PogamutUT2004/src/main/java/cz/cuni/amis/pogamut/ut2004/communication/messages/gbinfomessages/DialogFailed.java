package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
         ...
         *  
		Aynchronous message. Response to unsuccessfull DIALOG command. Dialog wasn't set for the player on the HUD. Reasons: player has not our bot selected or wrong player Id in DIALOG command.
 	...
 	public class DialogFailed 
		 ...
		 *   
		 *     @param Id 
			An Id of the dialog matching the one sent by client. Allows bot to match
		 ...
		 * @param original
		 */
		public DialogFailed(DialogFailed original) {		
