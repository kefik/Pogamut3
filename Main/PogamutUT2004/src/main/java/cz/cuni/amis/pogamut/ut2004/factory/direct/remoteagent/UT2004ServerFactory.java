...
/**
 * Factory that uses direct instantiation (plain old Java style) of the {@link UT2004Server} class.
 * <p><p>
 * Can't be used to instantiate other classes!
 * <p><p>
 * If you need to instantiate own {@link UT2004Server} descendant, use {@link cz.cuni.amis.pogamut.ut2004.factory.guice.remoteagent.UT2004ServerFactory}
 * and define own descendant of {@link UT2004ServerModule}.
 * @author Jimmy
 *
 * @param <PARAMS>
 */
public class UT2004ServerFactory<PARAMS extends UT2004AgentParameters> implements IAgentFactory<UT2004Server, PARAMS>{
	...
	public UT2004Server newAgent(PARAMS agentParameters) throws PogamutException {		
        ...
        UT2004Server server = new UT2004Server(agentParameters, logger, eventBus, socketConnection, worldView, act);        
        return server;
	}
