package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
 	...
 	;
        ...
        public  boolean isVisible()
 	 {
		...
		public static class VehicleLocalUpdate
     implements ILocalWorldObjectUpdatedEvent, IGBWorldObjectEvent
		{
			protected long time;
			
			protected VehicleLocal data = null; //contains object data for this update
			
			public VehicleLocalUpdate
    (VehicleLocal moverLocal, long time)
			{
					...
					ILocalWorldObject object) 
			{
				if ( object == null)
				{
					data = new VehicleLocalImpl(data); //we always return Impl object
				...
				if ( object instanceof VehicleLocalImpl )
				{
					VehicleLocalImpl toUpdate = (VehicleLocalImpl)object;
