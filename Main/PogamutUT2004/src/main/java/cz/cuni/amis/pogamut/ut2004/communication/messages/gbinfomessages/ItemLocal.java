package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
         ...
         */
 	public abstract class ItemLocal 
  						extends InfoMessage
 	...
 	;
		...
		public IStaticWorldObject getStatic() {
			...
			public static class ObjectDisappeared implements ILocalWorldObjectUpdatedEvent
			{
				...
				public ObjectDisappeared(ItemLocal obj, long time) {
					this.obj = obj;
					this.time = time;
				}
				
				private ItemLocal obj;
				private long time;
				...
				public IWorldObjectUpdateResult<ILocalWorldObject> update(ILocalWorldObject obj) 
				{
					...
					if (!(obj instanceof ItemLocalImpl)) {
						throw new PogamutException("Can't update different class than ItemLocalImpl, got class " + obj.getClass().getSimpleName() + "!", this);
					}
					ItemLocalImpl toUpdate = (ItemLocalImpl)obj;
					if (toUpdate.Visible) {
