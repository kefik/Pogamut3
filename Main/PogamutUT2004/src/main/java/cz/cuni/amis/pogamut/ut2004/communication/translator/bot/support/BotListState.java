...
public abstract class BotListState<MESSAGE, CONTEXT extends TranslatorContext> extends AbstractBotFSMState<InfoMessage, CONTEXT> {
	...
	public void stateEntering(CONTEXT context, IFSMState<InfoMessage, CONTEXT> fromState, InfoMessage symbol) {
		if (!symbol.getClass().equals(beginMessage)) {
			throw new UnexpectedMessageException(TranslatorMessages.unexpectedMessage(this, symbol, beginMessage), context.getLogger(), this);
		}
	}
	...
	public void stateLeaving(CONTEXT context,
		...
		if (!symbol.getClass().equals(endMessage)) {
			throw new UnexpectedMessageException(TranslatorMessages.unexpectedMessage(this, symbol, endMessage), context.getLogger(), this);		
		}
	}
