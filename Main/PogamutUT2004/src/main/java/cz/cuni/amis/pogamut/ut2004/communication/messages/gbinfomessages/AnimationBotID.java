package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
         ...
         *  
		Asynchronous message. Message by server to announce id for animation of a bot.
	
         */
 	public class AnimationBotID 
  				extends InfoMessage
		 ...
		 * 
 	  	 * 
		 *   
		 *     @param id id for animation of a bot.
		 *   
		 * 
		 */
		public AnimationBotID(
		 ...
		 * @param original
		 */
		public AnimationBotID(AnimationBotID original) {		
