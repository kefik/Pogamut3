package cz.cuni.amis.pogamut.ut2004.communication.messages.gbinfomessages;
 	...
 	;
        ...
        public  UnrealId getId()
 	 {
    	...
    	public static class BombInfoStaticUpdate
     implements IStaticWorldObjectUpdatedEvent
		{
			
			private BombInfoStatic data;
			private long time;
			
			public BombInfoStaticUpdate
    (BombInfoStatic source, long time)
			{
				this.data = source;
				this.time = time;
			}
			...
			public IWorldObjectUpdateResult<IStaticWorldObject> update(
				...
				if ( object == null)
				{
					data = new BombInfoStaticImpl(data);
				...
				if ( object instanceof BombInfoStaticImpl)
				{
					BombInfoStaticImpl orig = (BombInfoStaticImpl)object;
					...
					if ( data.isDifferentFrom(orig) )
					{
						...
						System.out.println("!!!!!ERROR!!!!!! in static object modification. Object class : BombInfoStaticImpl to see which property was different see !!!!PROPERTY UPDATE ERROR!!!!");
					}
					return new IWorldObjectUpdateResult.WorldObjectUpdateResult<IStaticWorldObject>(IWorldObjectUpdateResult.Result.SAME, data);
				}				
				throw new PogamutException("Unexpected object type for update, BombInfoStaticImpl expected not class " + object.getClass().getSimpleName() + ".", this);
			}
		}
