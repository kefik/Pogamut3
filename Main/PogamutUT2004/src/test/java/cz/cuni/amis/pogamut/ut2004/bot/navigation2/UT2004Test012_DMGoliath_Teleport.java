...
public class UT2004Test012_DMGoliath_Teleport extends UT2004BotTest {
	...
	public void test12_teleport_1_time_bothways() {
		startTest(
			...
			new Navigation2TestBotParameters("DM-Goliath.PathNode36",      "DM-Goliath.PathNode40",    1,                        true)
		);
	}
	...
	public void test12_teleport_20_time_bothways() {
		startTest(
			...
			new Navigation2TestBotParameters("DM-Goliath.PathNode36",      "DM-Goliath.PathNode40",    20,                        true)
		);
	}
