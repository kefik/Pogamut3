...
import cz.cuni.amis.pogamut.ut2004.bot.impl.test.LeakTestBotFactory;
...
public class UT2004Test10_LeakTestBot_Direct extends UT2004Test {
	...
	private static class MasterTest implements Runnable {
		...
		@Override
		public void run() {
			IAgentFactory factory = new LeakTestBotFactory();
	...
	@Test
    public void test() {
		Thread t = new Thread(new MasterTest(log, ucc.getBotAddress()), "LeakTestBot_Direct");		
		t.start();
		try {
			t.join();
