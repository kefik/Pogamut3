...
public class HunterBot extends UT2004BotModuleController<UT2004Bot> {
    ...
    public Initialize getInitializeCommand() {
        ...
        return new Initialize().setName("Hunter-" + (++instanceCount)).setDesiredSkill(5).setTeam((INSTANCE++ % 2) == 0 ? AgentInfo.TEAM_RED : AgentInfo.TEAM_BLUE);
    }
    ...
    @Override
    public void logic() {    	    	
    	log.info("#PLAYERS/#FRIENDS/#ENEMIES: " + players.getPlayers().size() + "/" + players.getFriends().size() + "/" + players.getEnemies().size());
    ...
    public static void main(String args[]) throws PogamutException {
    	...
    	new UT2004BotRunner(HunterBot.class, "Hunter").setMain(true).setLogLevel(Level.INFO).startAgents(6);
    }
}
