...
public class ComponentCantResumeException extends ComponentException {
	 ...
	 */
	public ComponentCantResumeException(String message, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantResumeException(String message, Throwable cause, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantResumeException(String message, Logger log, Object origin){
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantResumeException(String message, Throwable cause, Logger log, Object origin) {
