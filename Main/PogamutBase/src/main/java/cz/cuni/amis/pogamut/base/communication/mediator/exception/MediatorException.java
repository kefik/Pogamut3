...
public class MediatorException extends CommunicationException {
	 ...
	 */
	public MediatorException(String message, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public MediatorException(String message, Throwable cause, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public MediatorException(String message, Logger log, Object origin){
	 ...
	 * @param origin which object does produced the exception
	 */
	public MediatorException(String message, Throwable cause, Logger log, Object origin) {
