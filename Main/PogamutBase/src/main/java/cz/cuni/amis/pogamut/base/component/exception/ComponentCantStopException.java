...
public class ComponentCantStopException extends ComponentException {
	 ...
	 */
	public ComponentCantStopException(String message, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantStopException(String message, Throwable cause, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantStopException(String message, Logger log, Object origin){
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantStopException(String message, Throwable cause, Logger log, Object origin) {
