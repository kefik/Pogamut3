...
public class ComponentCantPauseException extends ComponentException {
	 ...
	 */
	public ComponentCantPauseException(String message, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantPauseException(String message, Throwable cause, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantPauseException(String message, Logger log, Object origin){
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentCantPauseException(String message, Throwable cause, Logger log, Object origin) {
