...
public class ComponentLifecycleManagementAlreadyRegisteredException extends ComponentException {
	 ...
	 */
	public ComponentLifecycleManagementAlreadyRegisteredException(String message, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentLifecycleManagementAlreadyRegisteredException(String message, Throwable cause, Object origin) {
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentLifecycleManagementAlreadyRegisteredException(String message, Logger log, Object origin){
	 ...
	 * @param origin which object does produced the exception
	 */
	public ComponentLifecycleManagementAlreadyRegisteredException(String message, Throwable cause, Logger log, Object origin) {
