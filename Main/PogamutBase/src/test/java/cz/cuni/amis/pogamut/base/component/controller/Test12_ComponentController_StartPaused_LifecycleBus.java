...
/**
 * Tests: start_paused/resume with LifecycleBus
 * @author Jimmy
 *
 */
import cz.cuni.amis.tests.BaseTest;
				
public class Test12_ComponentController_StartPaused_LifecycleBus extends BaseTest {
	
	@Test
	public void test() {
		IAgentId agentId = new AgentId("Test12_ComponentController_StartPaused_LifecycleBus");
