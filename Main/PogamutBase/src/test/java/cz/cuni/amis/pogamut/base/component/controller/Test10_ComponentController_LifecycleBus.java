...
/**
 * Testing starting/pausing/resuming/stopping + failures (fatal errors) == restarts ... with LifecycleBus.
 * @author Jimmy
 */
import cz.cuni.amis.tests.BaseTest;
				
public class Test10_ComponentController_LifecycleBus extends BaseTest {
	
	@Test
	public void test() {
		IAgentId agentId = new AgentId("Test10_ComponentController_LifecycleBus");
