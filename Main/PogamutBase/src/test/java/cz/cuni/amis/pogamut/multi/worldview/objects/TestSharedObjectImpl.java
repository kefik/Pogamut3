...
public class TestSharedObjectImpl extends TestSharedObject{
	...
	public TestSharedObject clone() {
		return new TestSharedObjectImpl( propertyMap.values() );
	}
	...
	public String toString() {
		return "TestSharedObjectImpl[id=" + getId() + ", time=" + getSimTime() + ", sharedString=" + getSharedString() + ", sharedLong=" + getSharedLong() + "]";
	}
	
	public static class TestSharedObjectUpdatedEvent implements ISharedWorldObjectUpdatedEvent
	{
		...
		@Override
		public String toString() {
			return "TestSharedObjectUpdatedEvent[id=" + getId() + ", time=" + getSimTime() + "]";
		}
