...
public class Test15_ComponentController_LifecycleBus_CreatedInBetween extends BaseTest {
	
	@Test
	public void test() {
		IAgentId agentId = new AgentId("Test15_ComponentController_LifecycleBus_CreatedInBetween");
