...
public class Test02_ComponentBus extends BaseTest {
	
	@Test
	public void test() {
		IAgentId agentId = new AgentId("Test02_ComponentBus");
		...
		bus.addEventListener(IStartingEvent.class, Test02_ComponentBus.class, listener6);
