...
public class Test05_ComponentBus extends BaseTest {

	@Test
	public void test01() {
		IAgentId agentId = new AgentId("Test05_ComponentBus");
		IAgentLogger logger = new AgentLogger(agentId);
		logger.addDefaultConsoleHandler();
		logger.setLevel(Level.ALL);
		final IComponentBus bus = new ComponentBus(logger);
	...
	public static void main(String[] args) {
		Test05_ComponentBus test = new Test05_ComponentBus();
		test.test01();
	}
