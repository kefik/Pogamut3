...
/**
 * Tests starting/pausing/resuming/stopping/starting... with LifecycleBus.
 * @author Jimmy
 */
import cz.cuni.amis.tests.BaseTest;
				
public class Test09_ComponentController_LifecycleBus extends BaseTest {
	
	@Test
	public void test() {
		IAgentId agentId = new AgentId("Test09_ComponentController_LifecycleBus");
