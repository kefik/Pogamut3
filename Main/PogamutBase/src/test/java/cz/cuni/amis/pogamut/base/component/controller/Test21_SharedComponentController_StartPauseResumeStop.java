...
/**
 * Tests: start/pause/resume/stop
 * @author Jimmy
 *
 */
import cz.cuni.amis.tests.BaseTest;
				
public class Test21_SharedComponentController_StartPauseResumeStop extends BaseTest {
	...
	@Test
	public void test() {
		IAgentId agentId1 = new AgentId("Test21_Shared-Agent1");
		IAgentId agentId2 = new AgentId("Test21_Shared-Agent2");
